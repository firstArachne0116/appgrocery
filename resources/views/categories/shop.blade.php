      ...
      <div class="row">
        <div class="col-12">
          ...
          <div id="products" class="row view-group">            
            @if($categories['data'])
            @foreach($categories['data'] as $catk => $catv)     
            <?php $imgs = json_decode($catv['image_path']); 
            $link = session('constant_url') . session('category_image_path'). '/'.$imgs[0]; ?>         
              <div class="item col-lg-3 col-md-3 mb-4 mb-4">
                <div class="thumbnail card product">
                  <div class="img-event"> <a class="group list-group-image" href="{{ route('subcategories', ['sid' => $marketid, 'cid' => $catv['id']]) }}"> <img class="img-fluid" src="<?php echo $link; ?>" alt=""></a> </div>
                  <div class="caption card-body">
                  
                    <h3 class="product-type1"></h3>
